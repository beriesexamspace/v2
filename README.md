...
## Regels
- Verandert een gedeeld bestand in `assets`? Verhoog dan in alle pagina's het nummer achter `?v=` (nu 28), anders zien telefoons nog tien minuten de oude versie.

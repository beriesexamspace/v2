...
- De startpagina (`index.html`) heeft bewust geen navigatiebalk en past in één schermhoogte. De getekende muisaanwijzer (overgenomen uit Helder) zit in `style.css` en `app.js`; hij kiest zwart of wit op basis van de berekende achtergrondkleur onder de muis, inclusief transparante bovenliggende vlakken. Op touch verschijnt hij niet.

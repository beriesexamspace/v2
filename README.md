...
## Regels
- Verandert een gedeeld bestand in `assets`? Verhoog dan in alle pagina's het nummer achter `?v=` (style.css nu 10, overige bestanden 9), anders zien telefoons nog tien minuten de oude versie.
